...
console.log(pessoa.nomeCompleto());//Olá! Meu nome écaue ferreira!
/*
...
console.log(pessoa.mostarPeso());//Eu peso 75 KG.
/*
...
return euSou+" "+ pessoa.nomeCompleto()+", tenho "+ pessoa.idade + " "+ anos +", "  + pessoa.altura +", meu peso é "+ pessoa.peso +" e, só hoje, eu já caminhei  "+ pessoa.caminhouQuantosMetros +" "+ metros+ "!"
